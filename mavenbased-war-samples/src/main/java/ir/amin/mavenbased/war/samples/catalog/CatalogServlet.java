 ...
 * for Annotation base definition :
 * @WebServlet("/CatalogServlet") -> @WLServlet (name = "catalogservlet", mapping = {"/CatalogServlet"})
 * from $WL_HOME/modules/com.bea.core.weblogic.web.api_1.4.0.0.jar 
 */
