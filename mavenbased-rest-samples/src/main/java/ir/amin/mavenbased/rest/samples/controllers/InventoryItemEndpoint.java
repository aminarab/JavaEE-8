...
import ir.amin.mavenbased.jpa.samples.entity.InventoryItem;
...
//		Collection<InventoryItem> values = inventoryitems.values().toArray();
		return Arrays.asList(inventoryitems.values().toArray(new InventoryItem[0]));
	}
